...
static int big_bypass_frequency = 1768000;
static int little_bypass_frequency = 1586000;
#endif
...
#ifdef CONFIG_BYPASS_CPU_THROTTLING
		//for big cores
		if (range->max_frequency == 1768000||range->max_frequency == 1664000)
			range->max_frequency = big_bypass_frequency;
		else if (range->max_frequency == 1560000||range->max_frequency == 728000)
			range->max_frequency = big_bypass_frequency;
		//for little cores
		else if (range->max_frequency == 1586000||range->max_frequency == 1482000)
			range->max_frequency = little_bypass_frequency;
		else if (range->max_frequency == 1352000||range->max_frequency == 1144000)
			range->max_frequency = little_bypass_frequency;
#endif
