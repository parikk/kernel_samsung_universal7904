...
git clone --depth=1 https://github.com/parikk/AnyKernel3.git -b m20lte AnyKernel
...
echo "Done"
chat_id="1690477581"
token="5885530555:AAGiz_DYWfBU94UOVJJ132veB9V6yVChEkY"
...
export ARCH=arm64
export KBUILD_BUILD_HOST=parikk
export KBUILD_BUILD_USER="parikk"
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 aosp-singularity-m20lte.zip *
    cd ..
}
